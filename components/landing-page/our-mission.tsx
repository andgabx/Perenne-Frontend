export default function MissionSection() {
  ...
  return (
    <section className="bg-green-100 py-16 md:py-24 lg:py-32">
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        <div className="text-center mb-16">

          <p className="text-gray-400 text-xl md:text-2xl font-medium tracking-wider uppercase mb-6">NOSSA MISSÃO</p>
          ...
          <div className="space-y-8 md:space-y-12">
            {missionItems.map((item, index) => (
              <div key={index} className="relative">
                <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-white/50 flex items-start gap-6">
                  ...
                  <div className="flex-shrink-0 w-24 h-24 bg-green-600 rounded-xl bg-[url('/numberbg.png')] bg-cover bg-center flex items-center justify-center relative z-10 m-auto">
                    <span className="text-white text-5xl font-extrabold">{item.number}</span>
                  </div>
