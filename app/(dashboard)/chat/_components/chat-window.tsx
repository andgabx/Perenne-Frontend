            ...
            <form onSubmit={handleChatSubmit} className="p-4 border-t mt-auto">
                <div className="flex items-center gap-2">
                    <Input
                        ...
                        className="flex-1 rounded-lg border-gray-300 bg-[#3C6C0C] text-white placeholder:text-white"
                        disabled={isSendingMessage}
                    />
                    <Button
                        type="submit"
                        className="bg-[#3C6C0C] hover:bg-[#5e8e2f] text-white font-semibold px-4 py-2 rounded-lg flex items-center gap-2 transition duration-150 ease-in-out"
